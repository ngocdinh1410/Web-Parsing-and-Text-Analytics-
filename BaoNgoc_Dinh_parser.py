...
"""
Spyder Editor
#Scraping movie reviews from Rotten Tomato
...
movie="parasite_2019" #the movie name as it appear in the link
...
for k in range(1,pageNum+1):
    ...
    for stuff in content:
        ...
        if icon: #find the rotten/fresh icon
